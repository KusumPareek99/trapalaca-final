...
SELECT job.job_title,job.job_id,job.rec_id,job.job_desc,job.last_date,job.location from job,recruiter WHERE job.job_title="<c:out
					value="${param.jtitle}" />" AND job.rec_id=<c:out
					value="${param.cid}" />;  
</sql:query>
