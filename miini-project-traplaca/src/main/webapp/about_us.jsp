...
<body>
		...
		<c:if test="${userType=='student'}">
			...
			<div class="items ">
				<a href="student_home_page.jsp">Home</a> <a
					...
					href="student_careerGuide.jsp">Career Guide</a> <a
					href="about_us.jsp" class="active ">About Us</a>
			</div>
		</c:if>
		...
		<c:if test="${userType=='company'}">
			...
			<div class="items ">
				<a href="Company_home.jsp">Home</a> <a href="job_post.jsp">Create
					a Job Post</a> <a href="about_us.jsp" class="active ">About Us</a>
			</div>
		</c:if>
		...
		<c:if test="${userType=='admin'}">
			...
			<div class="items ">
				<a href="admin_home.jsp">Home</a> <a href="admin_add_data.jsp">
					Add Career Training Data</a> <a href="about_us.jsp" class="active">About
					Us</a>
	...
	<div class="content">
		...
		<div id="scope">
			<h3>TraPlaCa</h3>
			<p>Traplaca is a system to guide students to choose right career
				and to give knowledge, skill, and aptitude and meet the skill
				requirements of the industry. This system aims to provide job
				opportunities. The required documents like the resume and photo will
				be stored for every student which could be viewed by the recruiters
				if the student has applied for the job .</p>
